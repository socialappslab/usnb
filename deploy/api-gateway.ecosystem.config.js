module.exports = {
    ...
    deploy: {
        production: {
            ...
            'post-deploy': 'npm install && npm install https://gitlab.inria.fr/usnb/message-transformer && pm2 reload /path/to/local/deploy/scripts/api-gateway.ecosystem.config.js --env dev',
            env: {
                NODE_ENV: 'production',
